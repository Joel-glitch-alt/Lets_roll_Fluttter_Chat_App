...
class MyCustomersInquiresFromCustomers extends StatefulWidget {
  const MyCustomersInquiresFromCustomers({super.key});

  @override
  State<MyCustomersInquiresFromCustomers> createState() => _MyCustomersInquiresFromCustomersState();
}

class _MyCustomersInquiresFromCustomersState extends State<MyCustomersInquiresFromCustomers> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return InkWell(
            onTap: () {
              context.go('/mycustomersmessaging');
            },
            child: Column(
              children: [
                Container(
