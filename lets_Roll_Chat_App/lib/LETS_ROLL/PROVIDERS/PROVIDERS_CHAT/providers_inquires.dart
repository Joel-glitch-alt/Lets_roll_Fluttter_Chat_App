...
import 'providers_inquirestoseller.dart';

//This file defines the Providers section of the Let's Roll app

class ProvidersInquiresSection extends StatefulWidget {
  const ProvidersInquiresSection({super.key});

  @override
  State<ProvidersInquiresSection> createState() =>
      _ProvidersInquiresSectionState();
}

class _ProvidersInquiresSectionState extends State<ProvidersInquiresSection> {
  int _selected = 0;
  int _itemSelected = 1;
  int _pageSelected = 2;

  final providersInquiresBodyContent = <Widget>[
    const ProvidersInquiresToSeller(),
  ];
            ...
            child: Container(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  MenuText(
                    menuText: 'My MakersTrust Purchases',
