...
import '../inquires_list_tiles.dart';
import 'message_cards.dart';
import 'messaging_appbar.dart';
import 'messaging_bottom_navbar.dart';


class MyCustomersInquiresChat extends StatelessWidget {
  const MyCustomersInquiresChat({super.key});
    ...
    return ListView(
      children: const [
        ...
        MessageOutgoing(
            name: 'Jane Warren',
            message:
                'This is the first phrase or sentence of my chat that is hidden inside this ... This is the first phrase or sentence of my chat that is hidden inside this ... This is the first phrase or sentence of my chat that is hidden inside this ... This is the first phrase or sentence of my chat that is hidden inside this ...',
            time: '4:15 AM'),
        MessageIncoming(
            name: 'Johnny Watson',
            message:
                'This is the first phrase or sentence of my chat that is hidden inside this ... This is the first phrase or sentence of my chat that is hidden inside this ...',
            time: '5:00 AM'),
        MessageOutgoing(
            name: 'Jane Warren',
            message:
...
class ProductInQuestion extends StatelessWidget {
  const ProductInQuestion({
    super.key,
  });
